...
\titlepl{Czy powinieneś się przejmować jakich narzędzi użyć do wykrywania fałszywych wiadomości? Studium porównawcze najnowocześniejszych metod embeddingu i algorytmów klasyfikacji}
